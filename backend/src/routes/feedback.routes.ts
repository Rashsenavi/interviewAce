...
router.post("/", authenticate, authorize("interviewer"), asyncHandler(submitFeedback));
...
router.get("/interviewer/analytics", authenticate, authorize("interviewer"), asyncHandler(getInterviewerAnalytics));
